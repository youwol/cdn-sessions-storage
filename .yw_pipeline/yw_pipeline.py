...
import youwol_cdn_sessions_storage
import youwol_utils
...
class PipelineFactory(IPipelineFactory):
    ...
    async def get(self, env: YouwolEnvironment, context: Context):
        ...
        async with context.start(
                action="Pipeline creation for cdn-sessions-storage",
                with_attributes={'project': 'cdn-sessions-storage'}
        ) as ctx:  # type: Context
            ...
            config = PipelineConfig(
                ...
                dockerConfig=CustomPublishDockerStepConfig(
                    ...
                    python_modules_copied=[
                        ...
                        Path(youwol_cdn_sessions_storage.__file__).parent
                    ]
                ),
